...
for( yr in RunYears ) {
  ...
  for(it in It) {
    ...
    for(md in Md) {
      ...
      #Step 5a: Calculate fuel & electricity consumption, CO2e production, & household costs
      #=====================================================================================
      ...
      #Clean up
      rm(CarSvcFuelElecCo2Rate_, CarSvcFuelElecCo2_, Filename)
    ...
    local( {
      ...
      CongPrice.ClFc <- 
        array( 0, dim=c( length(Cl), length(Fc) ), dimnames=list( Cl, Fc ) )
