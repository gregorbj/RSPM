...
Model_$RevMiFactors <- 
  readDataFile("revenue_mile_factors.csv",
               HasRowNameCol = TRUE,
               OutputAs = "ColumnToVector")
...
Inputs_$FuelCo2..Yr <-
  readDataFile("fuel_co2.csv",
               HasRowNameCol = TRUE,
               OutputAs = "DataFrame")
#Lane-miles by year, metropolitan area, and functional class
Inputs_$LaneMiles..YrFc <- 
  readDataFile("lane_miles.csv",
               HasRowNameCol = TRUE,
               OutputAs = "DataFrame")
...
Inputs_$PTService..YrMp <- 
  readDataFile("transit_service.csv",
               HasRowNameCol = TRUE,
               OutputAs = "DataFrame")
