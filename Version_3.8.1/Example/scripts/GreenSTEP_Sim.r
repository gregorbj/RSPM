...
FwyLnMi.Yr <- LaneMiles..YrFc$Fwy
names(FwyLnMi.Yr) <- rownames(LaneMiles..YrFc)
...
ArtLnMi.Yr <- LaneMiles..YrFc$Art
names(ArtLnMi.Yr) <- rownames(LaneMiles..YrFc)
...
#------------------------------------
RailRevMi.Yr <- rowSums(PTService..YrMp[Yr,RailModes])
BusRevMi.Yr <- rowSums(PTService..YrMp[Yr,BusModes])
BusEqService.Yr <- 
  rowSums(sweep(PTService..YrMp[Yr,Mp], 2, RevMiFactors[Mp], "*"))
TranRevMiCap.Yr <- BusEqService.Yr / MetroPop.Yr
rm(BusEqService.Yr)
